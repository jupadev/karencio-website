  ...
  <article className="flex flex-col min-h-screen overflow-hidden">
    ...
    <main className="container mt-8 mx-auto px-4 max-w-6xl mx-auto">
      <div className="relative pt-32 pb-10 md:pt-40 md:pb-16">
        <h1 className="mb-4 text-2xl font-extrabold leading-none tracking-tight text-gray-900 dark:text-white">Who We Are: Unleashing Creativity, Driving Innovation</h1>
        ...
        <section className="flex items-center flex-col flex-wrap justify-center my-8 gap-2">
          ...
          <p className="font-bold">Juan Pablo Vargas, CEO</p>
          <span className="italic">Consultant IT Specialist</span>
        </section>
        <section>
