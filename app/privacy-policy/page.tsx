    ...
    <div className="flex flex-col min-h-screen overflow-hidden max-w-6xl mx-auto">
      ...
      <main className="container mt-8 mx-auto px-4">
        <div className="relative pt-32 pb-10 md:pt-40 md:pb-16">
          ...
          <p>
            Welcome to <b> Karencio Dev LLC</b>.
          </p>
          <p>
            <b>Karencio Dev LLC</b> (“us”, “we”, or “our”) operates{" "}
            <b>karencio.com</b> (hereinafter referred to as <b>“Service”</b>).
          </p>
          <p>
            Our Privacy Policy governs your visit to <b>karencio.com</b>, and
          ...
          <p>
            <b>SERVICE</b> means the karencio.com website operated by Karencio
            Dev LLC.
          </p>
          <p>
          ...
          <p>Karencio Dev LLC uses the collected data for various purposes:</p>
          ...
          <p>
            Karencio Dev LLC will take all the steps reasonably necessary to
          ...
          <p>
            ...
            please send your request(s) by email: <b>hello@karencio.com</b>.
          </p>
          <p>
          ...
          <p>
            ...
            us by email: <b>hello@karencio.com</b>.
          </p>
          <p style={{ marginTop: "5em", fontSize: "0.7em" }}>
            This{" "}
            <a href="https://policymaker.io/privacy-policy/">Privacy Policy</a>{" "}
            was created for <b>karencio.com</b> by{" "}
            <a href="https://policymaker.io">PolicyMaker.io</a> on 2023-11-05.
          </p>
        </div>
      </main>
    </div>
